...
beautiful.init(gears.filesystem.get_configuration_dir() .. "wildbreath/theme.lua")
...
local function spawn_image_box()
   awful.spawn("feh -zZXN /home/kyle/Pictures/dbl_dyno.jpg")
end
-- }}}
...
globalkeys = gears.table.join(
    ...
    -- ImageBox @kyle
    awful.key({ modkey , "Shift" }, "\\", spawn_image_box,
    	      {description = "Brings up a fun picture", group = "launcher"})
